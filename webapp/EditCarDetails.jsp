...
<body>
	<h2 style="color: white; font-weight: bolder">Edit / Modify  Your Car
		Details</h2>
	<form action="/cars/EditCarDetailsControler">
		<div class="row mb-3">
		...
		<div class="row mb-3">
			<label for="3" class="col-sm-2 col-form-label">Car<br>Registered<br>Number
			</label> <br>
			<div class="col-sm-9">
		...
		<button type="submit" value="addit" class="btn btn-primary col-6">Update Car Details</button>
	</form>
</body>
</html>